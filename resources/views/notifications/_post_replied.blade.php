...
<li class="media list">
  ...
  <div class="media-body">
    <div class="text-dark text-xl-left mb-3" ><a href="{{ route('users.show',$notification->data['reply_user_id'])  }}">
        {{ $notification->data['reply_user_name'] }}</a> 在 {{ \Carbon\Carbon::create($notification->data['reply_created_at'])->diffForHumans() }} 留言</div>
